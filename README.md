...
<!-- Dropdown -->
  ...
  - 💬 Tenho 22 anos e atualmente moro em São Paulo. Tenho conhecimento em linguagem Python com foco na automatização de tarefas. Possuo conhecimentos dentro de Redes, Sistemas operacionais Linux e Windowns, Análise de erros, formatação de máquinas, lógica de programação, gerenciamento de arquivos e harware.
